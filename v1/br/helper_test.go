...
func CompareNPass(t *testing.T, cam *raster.Cam, e *Env, number int, name string, nPass int, tolerance float64, w, h int) {
	t.Helper()
...
func Compare(t *testing.T, cam *raster.Cam, e *Env, number int, name string, tolerance float64) {
	t.Helper()
	CompareNPass(t, cam, e, number, name, 1, tolerance, testW, testH)
}

func CompareImg(t *testing.T, cam *raster.Cam, e *Env, img raster.Image, number int, testName string, tol float64) {
	t.Helper()
